...
| `get_activity_summary` | `activity_and_fitness.readonly` | Daily steps, calories, active minutes, distance, active zone minutes, floors climbed, active energy burned, sedentary minutes, and calories burned in heart-rate zones for a date range (last 14 days by default) |
